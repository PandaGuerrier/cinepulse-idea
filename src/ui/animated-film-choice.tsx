...
import { IconArrowLeft, IconArrowRight, IconBellX, IconHeart, IconSkewX, IconX } from '@tabler/icons-react'
        ...
        <div className="gap-20 space-y-14">
          ...
          <div className="flex flex-col justify-between py-4">
            ...
            <div className="flex w-full justify-center gap-4 pt-12 md:pt-0">
              ...
              >
                <IconHeart className="h-14 w-14 text-white transition-transform duration-300 group-hover/button:-rotate-24" />
              </button>
            </div>
          </div>
        </div>
